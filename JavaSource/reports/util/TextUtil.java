...
public class TextUtil
{
               ...
               IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException( "Malformed ISO-8859-1 string?" );
        }
        ...
        try
        {
            processedPageName = new String(decodeBytes, 0, decodedByteCount, "ISO-8859-1") ;
        }
        catch (UnsupportedEncodingException e)
        {
            throw new UnsupportedEncodingException( "ISO-8859-1 encoding not supported on this platform" );
        }
    ...
    /**
     *  As java.net.URLDecoder class, but for ISO-8859-1 strings.
     */
     ...
     * Encoding may be ISO-8859-1 or ISO-8859-1 (default).
     *
