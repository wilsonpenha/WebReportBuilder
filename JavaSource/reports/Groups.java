...
public class Groups extends PObject{
  ...
  */
  ...
  public boolean getIsReprintHeaderOnNewPage(){return this.isReprintHeader.equals("Yes");}
  /**
  * Access groupExpression: Group Expression
  */
  public java.lang.String getGroupExpression(){return this.groupExpression;}

  public java.math.BigDecimal getOrder() {return order;}
  ...
  /*-------------------------------------------------------------------------
                      Access Methods SET
  -------------------------------------------------------------------------*/
  public void setOrder(java.math.BigDecimal decimal) {order = decimal;}
  /**
  ...
  * Find a Object by ID
  */
  public static Groups findByID(
        java.math.BigDecimal groupsId)
  throws Exception{
  ...
  * that relationaship with Report provide
  */
  public ArrayList getHeaderColumns()
  throws Exception{
	GroupColumns obj = new GroupColumns();
	obj.setGroups(this);
	obj.setBandType("Header");
	return new ArrayList(getList(obj, null));
  }
  /**
  * Bring all Obejct for this class 
  * that relationaship with Report provide
  */
  public ArrayList getFooterColumns()
  throws Exception{
	GroupColumns obj = new GroupColumns();
	obj.setGroups(this);
	obj.setBandType("Footer");
	return new ArrayList(getList(obj, null));
  }
  /**
  * Bring all Obejct for this class 
  * that relationaship with Report provide
  */
  public static Vector findByReportOrderByOrder(Report report)
  throws Exception{
	Groups obj = new Groups();
	Vector v = new Vector();
