...
import reports.bean.BeanColumns;
 ...
 * @author
 */
public class BeanSummaryColumnsAction extends BeanAction

{
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
			...
			BeanColumns beanObj = (BeanColumns)form;
			beanObj.setBandType("Summary");
            beanObj.execute();
