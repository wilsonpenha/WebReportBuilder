 ...
 * @author
 */
public class BeanParametersAction extends BeanAction

{
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            beanObj.execute();
			if (beanObj.getDbAction().equals(String.valueOf(beanObj.ACTION_FORM_INSERT))){
	        	return mapping.findForward("showFormInsert");
			}else if (beanObj.getDbAction().equals(String.valueOf(beanObj.ACTION_SELECT_LIST))){
