...
public class MDIToolbar extends BorderLayoutPanel
{
    public MDIToolbar()
    {
		...
		toolbar.add(Application.application.getAction(MDIActions.ACTION_MDI_SHOW_EXPLORER));
		toolbar.add(Application.application.getAction(MDIActions.ACTION_MDI_SHOW_EDITOR));
		toolbar.add(Application.application.getAction(MDIActions.ACTION_MDI_SHOW_COMPARER));
		toolbar.addSeparator();
		toolbar.add(Application.application.getAction(MDIActions.ACTION_SHOW_PREFERENCES));
		toolbar.addSeparator();
