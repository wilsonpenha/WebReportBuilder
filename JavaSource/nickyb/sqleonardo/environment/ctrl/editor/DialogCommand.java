...
public class DialogCommand extends AbstractDialogConfirm implements _BuildOwner
{
	...
	{
		super(Application.application,"command",640,480);
	...
	{
		return SQLFormatter.ensureQuotes(querytoken.getIdentifier(),this.getIdentifierQuoteString(),false);
	}
	...
	private void loadBuilders()
	{
		...
		try
		{
			...
			{
				QueryTokens.Column qColumn = new QueryTokens.Column(querytoken,rsColumns.getString(4));
