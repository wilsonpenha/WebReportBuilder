...
public class QueryModelTreeCellRenderer extends DefaultTreeCellRenderer {
    ...
    static ImageIcon queryRootIcon;
    ...
    public QueryModelTreeCellRenderer() {
        ...
        if (queryRootIcon == null) queryRootIcon = new javax.swing.ImageIcon(getClass().getResource("/images/page_white_database.png"));
        ...
        if (selectIcon == null) selectIcon = new javax.swing.ImageIcon(getClass().getResource("/images/accept.png"));
    ...
    public Component getTreeCellRendererComponent(
        ...
        JLabel jlabel = (JLabel)super.getTreeCellRendererComponent(
                        tree, value, sel,
                        expanded, leaf, row,
                        hasFocus);
    ...
    protected ImageIcon getElementIcon(Object value) {
        ...
        if (value instanceof BrowserItems.QueryTreeItem) return queryRootIcon;
        ...
        if (value instanceof BrowserItems.FromTreeItem) return whereIcon;
        
        if (value instanceof DefaultMutableTreeNode &&
            ((DefaultMutableTreeNode)value).getParent() != null &&
            ((DefaultMutableTreeNode)value).getParent() instanceof BrowserItems.FromTreeItem)
        {
            return tableIcon;
        }
