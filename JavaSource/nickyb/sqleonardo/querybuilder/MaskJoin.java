...
public class MaskJoin extends BaseMask
{
	...
	public MaskJoin(DiagramRelation relation,QueryBuilder builder)
	{
		...
		allLeft = new JCheckBox(I18n.getFormattedString("querybuilder.checkbox.allRowsFrom","all rows from {0}", new Object[]{ ""+relation.primaryEntity.getQuerytoken().getReference()}) );
		...
		allRight = new JCheckBox(I18n.getFormattedString("querybuilder.checkbox.allRowsFrom","all rows from {0}", new Object[]{ "" + relation.foreignEntity.getQuerytoken().getReference()}) );
