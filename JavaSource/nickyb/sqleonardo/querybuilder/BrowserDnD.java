...
public class BrowserDnD implements DragGestureListener, DragSourceListener, DropTargetListener
{
	...
	public void drop(DropTargetDropEvent dtde)
	{
		...
		BrowserItems.DefaultTreeItem itemParent = itemAfter;
		
                System.out.println("FROM " + itemSource);
                System.out.println("TO " + itemAfter);
		...
		else
		{
			performDrop = itemParent.isNodeChild(itemSource);
                ...
                System.out.println("Perform drop= " + performDrop);
