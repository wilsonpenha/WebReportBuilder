...
function TableSort(myTable, myCol, myType, sRow, cf) {
  ...
  counter=0;
	...
	waitWindow()
		...
		document.all.WaitMessageId.style.display = "none" ;
	}
	return 0;
}
...
document.all.WaitMessageId.style.display = "block" ;
...
str+='<DIV class="waitTable" style="position:absolute;top:55px;left:'+((document.body.clientWidth / 2)-80)+'px;border:0.04cm outset grey">'
str+='<img src="common/images/PleaseWait.gif">'
str+='</DIV>'
str+='</DIV>'
