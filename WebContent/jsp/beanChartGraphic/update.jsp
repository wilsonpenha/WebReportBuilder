    ...
    <td>
          <table width="100%" border="0" cellPadding="0" cellSpacing="0">
            ...
            <tr>
              ...
              <td width="66%" class="inputLocation">
                <textarea class="dataInput" name="subDataSet" tabIndex="8" cols="80" rows="15"><%=beanPage.getSubDataSet()%></textarea>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="66%" class="inputLocation">
                <textarea class="dataInput" name="chartBandCode" tabIndex="8" cols="80" rows="15"><%=beanPage.getChartBandCode()%></textarea>
              </td>
            </tr>
            <tr>
              ...
              <td width="66%" class="inputLocation">
                <Select name="bandLocation" tabIndex="9">
                   <option value="titleHeader" <%if (beanPage.getBandLocation().equals("titleHeader")){out.print("selected");}%>>Title header</option>
                   <option value="titleFooter" <%if (beanPage.getBandLocation().equals("titleFooter")){out.print("selected");}%>>Title footer</option>
                   <option value="pageHeader" <%if (beanPage.getBandLocation().equals("pageHeader")){out.print("selected");}%>>Page Header</option>
                   <option value="pageFooter" <%if (beanPage.getBandLocation().equals("pageFooter")){out.print("selected");}%>>Page Footer</option>
                   <option value="groupHeader" <%if (beanPage.getBandLocation().equals("groupHeader")){out.print("selected");}%>>Group Header</option>
                   <option value="groupFooter" <%if (beanPage.getBandLocation().equals("groupFooter")){out.print("selected");}%>>Group Footer</option>
                   <option value="summary" <%if (beanPage.getBandLocation().equals("summary")){out.print("selected");}%>>Summary</option>
                   <option value="detail" <%if (beanPage.getBandLocation().equals("detail")){out.print("selected");}%>>Detail</option>
                </Select>
              </td>
            </tr>
            <tr>
