    ...
    <td>
          <table width="100%" border="0" cellPadding="0" cellSpacing="0">
            ...
            <tr>              <td width="32%" class="dataLabel">*Column Expression : </td>              <td width="66%" class="inputLocation">
                ...
                <input type="button" name="Submit" style="{height:20px; width: 49px;}" class="stdButton" id="btnFields" value="Fields" onClick="javascript:document.getElementById('loadFrame').src='fieldList.jsp?reportId=<%=beanPage.getReportId()%>&field=columnExpression';">
