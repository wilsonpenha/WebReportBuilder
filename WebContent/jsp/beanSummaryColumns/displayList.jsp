...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter">Summary Columns - List</td>
  </tr>
  <tr> 
    <td>
          ...
          <td>
            <table width="100%" border="0" cellPadding="0" cellSpacing="0">
              ...
              <tr>
                ...
                <%
                  String[] ids = {"columnsId"};
                  String[] objValues = {"columnName", "width", "alignment", "classType", "order", "bandType"};
                  String[] titles = {"", "Column Name", "Width", "Alignment", "Class Type", "order", "bandType"};
