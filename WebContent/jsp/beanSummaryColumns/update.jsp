...
<script language="javascript" src="<%=request.getContextPath()%>/jsp/beanSummaryColumns/script.js"></script>
...
<form method="post" action="<%=request.getContextPath()%>/beanSummaryColumns.do" onSubmit="return ConfirmaSubmit(this,'<%=beanPage.getBeanForm()%>')">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter">Summary Columns - Edit</td>
  </tr>
  <tr> 
    <td>
	  <div id="tabGuia" style="width:100%; height:20px; z-index:1; overflow: hidden" >
		<% String tabName = PropertiesManager.getString("app.tab.summaryCols",request); %>
    ...
    <td>
          <table width="100%" border="0" cellPadding="0" cellSpacing="0">
            <tr>              <td width="32%" class="dataLabel">*Column Name : </td>              <td width="66%" class="inputLocation">                <input type="hidden" name="reportId" value="<%=beanPage.getReportId()%>">                <input type="hidden" name="columnsId" value="<%=beanPage.getColumnsId()%>">                <input type="text" class="dataInput" name="columnName" tabIndex="3" maxlength="50" size="50" value="<%=beanPage.getColumnName()%>">              </td>            </tr>            <tr>
              <td width="32%" class="dataLabel">*Label Width : </td>
              <td width="66%" class="inputLocation">
                <input type="text" class="dataInput" name="labelWidth" tabIndex="4" maxlength="5" size="5" value="<%=beanPage.getLabelWidth()%>">
              </td>
            </tr>
