...
<%
	...
	String[] tabSheetOff = {report,queryB,variables,params,fields,detailC,titleC,pageC,summaryC,groups,groupsC};
	...
	String[] tabSheetOffSize = {"40","85","55","70","35","65","60","60","82","40","75"};
%>
