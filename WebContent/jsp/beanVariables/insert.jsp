...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter"><bean:message key="tabVariable.label.variableInsert"/></td>
  </tr>
  <tr> 
    <td>
    ...
    <td>
          <table width="100%" border="0" cellPadding="0" cellSpacing="0">
            <tr>              <td width="32%" class="dataLabel"><bean:message key="tabVariable.label.variableName"/> : </td>              <td width="66%" class="inputLocation">                <input type="hidden" name="variablesId" value="<%=beanPage.getVariablesId()%>">                <input type="hidden" name="reportId" value="<%=beanPage.getReportId()%>">                <input type="text" class="dataInput" name="variableName" tabIndex="3" maxlength="30" size="30" value="<%=beanPage.getVariableName()%>">              </td>            </tr>            <tr>              <td width="32%" class="dataLabel"><bean:message key="tabVariable.label.variableDescription"/> : </td>              <td width="66%" class="inputLocation">                <input type="text" class="dataInput" name="variableDescription" tabIndex="4" maxlength="30" size="30" value="<%=beanPage.getVariableDescription()%>">              </td>            </tr>            <tr>              <td width="32%" class="dataLabel">*<bean:message key="tabVariable.label.classType"/> : </td>              <td width="66%" class="inputLocation">                <%
              ...
              </td>            </tr>            <tr>              <td width="32%" class="dataLabel"><bean:message key="tabVariable.label.resetType"/> : </td>              <td width="66%" class="inputLocation">                <Select name="resetType">
            ...
            <tr>
              <td width="32%" class="dataLabel"><bean:message key="tabVariable.label.incrementType"/> : </td>
              <td width="66%" class="inputLocation">
