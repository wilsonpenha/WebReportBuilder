...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter"><bean:message key="tabVariable.label.variableList"/></td>
  </tr>
  <tr> 
    <td>
          ...
          <td>
            <table width="100%" border="0" cellPadding="0" cellSpacing="0">
              ...
              <tr>
                ...
                <%
                  String variableName = PropertiesManager.getString("tabVariable.label.variableName",request);
                  String classType = PropertiesManager.getString("tabVariable.label.classType",request);
                  String calculation = PropertiesManager.getString("tabVariable.label.calculation",request);
                  String[] ids = {"variablesId"};
                  String[] objValues = {"variableName", "classType", "calculation"};
                  String[] titles = {"", variableName, classType, calculation};
