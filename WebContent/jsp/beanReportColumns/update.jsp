...
<script language="javascript" src="<%=request.getContextPath()%>/jsp/beanReportColumns/script.js"></script>
...
<form method="post" action="<%=request.getContextPath()%>/beanReportColumns.do" onSubmit="return ConfirmaSubmit(this,'<%=beanPage.getBeanForm()%>')">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter">Title Cols - Edit</td>
  </tr>
  <tr> 
    <td>
	  <div id="tabGuia" style="width:100%; height:20px; z-index:1; overflow: hidden" >
		<% String tabName = PropertiesManager.getString("app.tab.titleCols",request); %>
