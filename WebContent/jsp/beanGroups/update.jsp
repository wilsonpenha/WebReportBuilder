...
<script language="javascript" src="<%=request.getContextPath()%>/jsp/beanGroups/script.js"></script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter">Groups - Edit</td>
  </tr>
  <tr> 
    <td>
