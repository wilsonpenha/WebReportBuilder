...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="30" class="topTitleCenter"><bean:message key="tabReports.label.reportList"/></td>
  </tr>
        <tr>
          <td>
            <table width="100%" border="0" cellPadding="0" cellSpacing="0">
              ...
              <tr>
                ...
                <%
                  String reportName = PropertiesManager.getString("tabReports.label.reportName",request);
                  String orientation = PropertiesManager.getString("tabReports.label.orientation",request);
                  String[] ids = {"reportId"};
                  String[] objValues = {"reportName", "orientation"};
                  String[] titles = {"", reportName, orientation};
                  String[] colsWidth = {"1%", "50%", "50%"};
				  int blsz = Integer.parseInt(beanPage.getBlockSize());
				  int blnu = Integer.parseInt(beanPage.getBlockNumber());
                %>
