	  ...
	  <td align="center">
		<table border="0" cellPadding="0" cellSpacing="4">
		  <tr>
			...
			<td><input type="button" value=" <bean:message key="app.button.run"/> "     style="width: 38px;" onClick="javascript:buildReport('<%=request.getContextPath()%>/reportPreview.do?reportId=<%=beanPage.getReportId()%>&reload=true&service=designer&format='+getFormat(document.forms[0])+'&isGraphic='+document.getElementById('isGraphic').checked);" name="btnNew" class="stdButton" onMouseOver="javascript:mensagem('<bean:message key="app.button.run.msg"/>');"></td>
		  </tr>
		</table>
	  </td>
	</tr>
