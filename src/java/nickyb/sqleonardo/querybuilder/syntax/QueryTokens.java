...
public abstract class QueryTokens
{
	...
	public static class DefaultExpression implements _Expression
	{
	...
	public abstract static class AbstractDatabaseObject
	{
	...
	public static class Column extends AbstractDatabaseObject implements _Expression
	{
		...
		{
			return owner.getReference() + SQLFormatter.DOT + SQLFormatter.ensureQuotes(this.getName(),!QueryBuilder.useAlwaysQuote);
		}
