...
public class BeanChartGraphic extends RptBeanObject {
	...
	/*-------------------------------------------------------------------------
	                  Access Methods
	-------------------------------------------------------------------------*/
	public java.lang.String getChartGraphicId() {
		return this.chartGraphicId;
	}

	public void setChartGraphicId(java.lang.String chartGraphicId) {
	...
	public void setChartWidth(java.lang.String chartWidth) {
	...
	protected PObject getPObjectInstance() {
		return new reports.ChartGraphic();
	}

	protected void selectList() throws Exception {
		Report report = new Report();
		report.setReportId(new BigDecimal(this.getReportId()));
		this.list = reports.ChartGraphic.findByReport(report);
	}

	protected void selectObject(String[] idValues) throws Exception {
		this.pobject = reports.ChartGraphic.findByID(new java.math.BigDecimal(idValues[0]));
	}
