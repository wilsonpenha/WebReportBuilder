...
public class BeanGroupColumns extends RptBeanObject {
	...
	public java.lang.String getGroupColumnsId() {
		return this.groupColumnsId;
	}

	public void setGroupColumnsId(java.lang.String groupColumnsId) {
	...
	protected PObject getPObjectInstance() {
		return new reports.GroupColumns();
	}
	...
	protected void selectObject(String[] idValues) throws Exception {
		this.pobject = reports.GroupColumns.findByID(new java.math.BigDecimal(idValues[0]));
	}
}
