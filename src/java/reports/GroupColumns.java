...
public class GroupColumns extends PObject {
	 ...
	 */
	public java.math.BigDecimal getGroupColumnsId() {
		return this.groupColumnsId;
	}
	...
	public int getIntLabelWidth() {
		return this.labelWidth.intValue();
	}
	 ...
	 */
	public java.lang.String getBandType() {
	...
	public java.lang.String getIsPrintHeader() {
		return isPrintHeader;
	}

	public java.math.BigDecimal getLabelWidth() {
		return labelWidth;
	}

	public void setLabelWidth(java.math.BigDecimal labelWidth) {
	 ...
	 */
	public void setGroupColumnsId(java.math.BigDecimal groupColumnsId) {
		this.groupColumnsId = groupColumnsId;
	}
	 ...
	 */
	public void setBandType(java.lang.String bandType) {
	...
	public void setIsPrintHeader(java.lang.String string) {
		isPrintHeader = string;
	}
	...
	public Groups getGroups() throws Exception {
		if ((this.getGroupsId() == null))
			return null;
		return Groups.findByID(this.getGroupsId());
	}

	public void setGroups(Groups obj) throws Exception {
		this.setGroupsId(obj != null ? obj.getGroupsId() : null);
	}
	 ...
	 * Find a Object by ID
	 */
	public static GroupColumns findByID(java.math.BigDecimal groupColumnsId) throws Exception {
	...
	/**
	 * Bring all Obejct for this class that relationaship with Groups provide
	 */
	public static Vector findByGroups(Groups object, String transID) throws Exception {
		GroupColumns obj = new GroupColumns();
	 ...
	 * Bring all Obejct for this class that relationaship with Groups provide
	 */
	public static Vector findByGroups(Groups groups) throws Exception {
		GroupColumns obj = new GroupColumns();
		Vector v = new Vector();
		v.add(groups.getGroupsId());
		return getList("findByGroups", v, obj, null);
	}

	/**
	 * Bring all Obejct for this class that relationaship with Groups provide
	 */
	public static Vector findByGroupsBandType(Groups groups, String bandType) throws Exception {
		GroupColumns obj = new GroupColumns();
		Vector v = new Vector();
		v.add(groups.getGroupsId());
		v.add(bandType);
		return getList("findByGroupsBandType", v, obj, null);
	}
